    ...
    <x-slot name="header">
        <div class="flex items-center space-x-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ $isEditing ? __('Edit Branch') : __('Create Branch') }}
            </h2>
        </div>
    </x-slot>
                ...
                <form wire:submit="save" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="code" wire:model="code"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm uppercase"
                            placeholder="e.g., HQ001" maxlength="10">
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                            A unique code for this branch (auto-generated if left empty)
                        </p>
                        @error('code')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        @enderror
