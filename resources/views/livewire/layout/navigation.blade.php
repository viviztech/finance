...
<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @can('loans.view')
                        <x-nav-link :href="route('loans.index')" :active="request()->routeIs('loans.*')" wire:navigate>
                            {{ __('Loans') }}
                        </x-nav-link>
                    @endcan
                    ...
                    @can('penalties.view')
                        <x-nav-link :href="route('penalties.index')" :active="request()->routeIs('penalties.*')"
                            wire:navigate>
                            {{ __('Penalties') }}
                        </x-nav-link>
                    @endcan
                    ...
                    @can('reports.view-branch')
                        <x-nav-link :href="route('reports.branch')" :active="request()->routeIs('reports.*')" wire:navigate>
                            {{ __('Reports') }}
                        </x-nav-link>
                    @endcan
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @can('loans.view')
                <x-responsive-nav-link :href="route('loans.index')" :active="request()->routeIs('loans.*')" wire:navigate>
                    {{ __('Loans') }}
                </x-responsive-nav-link>
            @endcan
