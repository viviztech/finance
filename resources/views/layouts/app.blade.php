        ...
        <aside class="w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-30">
            ...
            <div class="p-6 border-b border-gray-100">
                <a href="{{ route('dashboard') }}" wire:navigate class="flex items-center gap-3">
                    ...
                    <span class="text-xl font-bold text-gray-900">FinanceFlow</span>
                </a>
            </div>
            ...
            <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                @can('payments.view')
                    <a href="{{ route('payments.index') }}" wire:navigate
                        class="sidebar-item relative flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs('payments.*') ? 'active' : 'text-gray-700' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
